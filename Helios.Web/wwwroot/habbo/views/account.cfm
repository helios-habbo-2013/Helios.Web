...
<div class="box-content">
	...
	<form action="app/func/updateUserSettings.cfm" method="post" id="profileForm" onsubmit="return false;">
		...
		<p>
			<label><input type="checkbox" name="emailNewsletterEnabled" value="true" id="emailNewsletterEnabled" <cfif getUserSettings.subscribed eq "1">checked="checked"</cfif>> Yes! I want the latest <cfoutput>#sitename#</cfoutput> news sent straight to my inbox.</label>
		</p>
